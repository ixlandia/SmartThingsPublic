...
def refresh() {
	commands([
        ...
        zwave.configurationV1.configurationSet(parameterNumber: 121,size: 1, scaledConfigurationValue: 1),
        	//(Sets S1 external switch mode): 1 = reserved, 2 = 3-way switch mode, 3 = Push button mode, 4 = automatic identification mode 
        zwave.configurationV1.configurationSet(parameterNumber: 35,size: 1, scaledConfigurationValue: 40) //sets the total up/down time in seconds, this setting is used to calibrate the total up and down time.
	])
}
